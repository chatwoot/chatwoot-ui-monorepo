...
import ChatCard from '@chatwoot/shared/components/ChatCard.vue';
import ChatForm from '@chatwoot/shared/components/ChatForm.vue';
import ChatOptions from '@chatwoot/shared/components/ChatOptions.vue';
import ChatArticle from './template/Article.vue';
import EmailInput from './template/EmailInput.vue';
import CustomerSatisfaction from '@chatwoot/shared/components/CustomerSatisfaction.vue';
