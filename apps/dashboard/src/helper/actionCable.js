...
import BaseActionCableConnector from '@chatwoot/shared/helpers/BaseActionCableConnector';
...
class ActionCableConnector extends BaseActionCableConnector {
  ...
  onContactDelete = data => {
    this.app.$store.dispatch('contacts/deleteContactThroughConversations', data.id);
    this.fetchConversationStats();
  };
