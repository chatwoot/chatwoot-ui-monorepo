import * as MutationHelpers from '@chatwoot/shared/helpers/vuex/mutationHelpers';
...
const computeDistribution = (value, total) => ((value * 100) / total).toFixed(2);
...
export const mutations = {
  ...
  [types.SET_CSAT_RESPONSE_METRICS](
    _state,
    { total_count: totalResponseCount, ratings_count: ratingsCount, total_sent_messages_count: totalSentMessagesCount }
  ) {
