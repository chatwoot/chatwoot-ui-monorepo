...
describe('#NotificationAPI', () => {
  ...
  describe('API calls', () => {
    ...
    it('#get', () => {
      ...
      expect(axiosMock.get).toHaveBeenCalledWith('/api/v1/notifications?page=1');
    });

    it('#getNotifications', () => {
      notificationsAPI.getNotifications(1);
      expect(axiosMock.get).toHaveBeenCalledWith('/api/v1/notifications/1/notifications');
    });

    it('#getUnreadCount', () => {
      notificationsAPI.getUnreadCount();
      expect(axiosMock.get).toHaveBeenCalledWith('/api/v1/notifications/unread_count');
    });

    it('#read', () => {
      notificationsAPI.read(48670, 'Conversation');
      expect(axiosMock.post).toHaveBeenCalledWith('/api/v1/notifications/read_all', {
