<template>
  <div class="resolve-actions relative flex items-center justify-end">
    ...
    <woot-modal v-model:show="showCustomSnoozeModal" :on-close="hideCustomSnoozeModal">
...
export default {
  ...
  mounted() {
    emitter.on(CMD_SNOOZE_CONVERSATION, this.onCmdSnoozeConversation);
    emitter.on(CMD_REOPEN_CONVERSATION, this.onCmdOpenConversation);
    emitter.on(CMD_RESOLVE_CONVERSATION, this.onCmdResolveConversation);
  },
  destroyed() {
