    ...
    <div class="p-8">
      <div v-if="isFolderView">
        <label class="input-label" :class="{ error: !activeFolderNewName }">
          ...
          <input v-model="activeFolderNewName" type="text"
      ...
      <div
        ...
        <filter-input-box v-for="(filter, i) in appliedFilters" :key="i" v-model="appliedFilters[i]"
          :filter-groups="filterGroups" :input-type="getInputType(
          ...
          :show-user-input="showUserInput(appliedFilters[i].filter_operator)" :grouped-filters="true"
          :v="v$.appliedFilters.$each[i]" @resetFilter="resetFilter(i, appliedFilters[i])"
      ...
      <div class="w-full">
        <div class="flex flex-row justify-end gap-2 py-2 px-0 w-full">
          ...
          <woot-button v-if="isFolderView" :disabled="!activeFolderNewName" @click="updateSavedCustomViews">
