...
import configMixin from '@chatwoot/shared/mixins/configMixin';
...
import { isEscape } from '@chatwoot/shared/helpers/KeyboardHelpers';
...
import { REPLY_POLICY } from '@chatwoot/shared/constants/links';
