  ...
  <div class="flex flex-col justify-between flex-grow h-full min-w-0 m-0">
    ...
    <ul class="conversation-panel">
      ...
      <message v-for="message in getReadMessages" :key="message.id" class="message--read ph-no-capture"
        ...
        :is-web-widget-inbox="isAWebWidgetInbox" :is-a-facebook-inbox="isAFacebookInbox" :is-instagram="isInstagramDM"
        :inbox-supports-reply-to="inboxSupportsReplyTo" :in-reply-to="getInReplyToMessage(message)" />
      ...
      <message v-for="message in getUnReadMessages" :key="message.id" class="message--unread ph-no-capture"
        data-clarity-mask="True" :data="message" :is-a-tweet="isATweet" :is-a-whatsapp-channel="isAWhatsAppChannel"
        :is-web-widget-inbox="isAWebWidgetInbox" :is-a-facebook-inbox="isAFacebookInbox" :is-instagram-dm="isInstagramDM"
        :inbox-supports-reply-to="inboxSupportsReplyTo" :in-reply-to="getInReplyToMessage(message)" />
    ...
    <div class="conversation-footer" :class="{ 'modal-mask': isPopoutReplyBox }">
      ...
      <reply-box :conversation-id="currentChat.id" v-model:popout-reply-box="isPopoutReplyBox"
