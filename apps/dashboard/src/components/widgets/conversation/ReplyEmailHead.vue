  ...
  <div>
    <div v-if="toEmails">
      <div class="input-group small" :class="{ error: v$.toEmailsVal.$error }">
        ...
        <div class="input-group-field">
          <woot-input v-model.trim="v$.toEmailsVal.$model" type="text" :class="{ error: v$.toEmailsVal.$error }"
            :placeholder="$t('CONVERSATION.REPLYBOX.EMAIL_HEAD.CC.PLACEHOLDER')" @blur="onBlur" />
        </div>
      </div>
    </div>
    <div class="input-group-wrap">
      <div class="input-group small" :class="{ error: v$.ccEmailsVal.$error }">
        ...
        <div class="input-group-field">
          <woot-input v-model.trim="v$.ccEmailsVal.$model" type="text" :class="{ error: v$.ccEmailsVal.$error }"
            :placeholder="$t('CONVERSATION.REPLYBOX.EMAIL_HEAD.CC.PLACEHOLDER')" @blur="onBlur" />
        </div>
        <woot-button v-if="!showBcc" variant="clear" size="small" @click="handleAddBcc">
    ...
    <div v-if="showBcc" class="input-group-wrap">
      <div class="input-group small" :class="{ error: v$.bccEmailsVal.$error }">
        ...
        <div class="input-group-field">
          <woot-input v-model.trim="v$.bccEmailsVal.$model" type="text" :class="{ error: v$.bccEmailsVal.$error }"
            :placeholder="$t('CONVERSATION.REPLYBOX.EMAIL_HEAD.BCC.PLACEHOLDER')
              " @blur="onBlur" />
        </div>
      </div>
