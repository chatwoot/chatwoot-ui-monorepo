<template>
  <div class="w-full flex flex-row">
    ...
    <delete-custom-views v-if="showDeleteSegmentsModal" v-model:show-delete-popup="showDeleteSegmentsModal"
    ...
    <woot-modal v-model:show="showFiltersModal" :on-close="closeAdvanceFiltersModal" size="medium">
