<template>
  <div class="overflow-auto p-6">
    <form @submit.prevent="updateUser('profile')">
      <div class="flex flex-row border-b border-slate-50 dark:border-slate-700 items-center flex p-4">
        ...
        <div class="p-4 w-[45%]">
          ...
          <label :class="{ error: v$.displayName.$error }">
            ...
            <input v-model="displayName" type="text" :placeholder="$t('PROFILE_SETTINGS.FORM.DISPLAY_NAME.PLACEHOLDER')
    ...
    <div
      ...
      <div class="p-4 w-[45%] flex flex-row">
        <button v-for="keyOption in keyOptions" :key="keyOption.key" class="cursor-pointer mr-4"
