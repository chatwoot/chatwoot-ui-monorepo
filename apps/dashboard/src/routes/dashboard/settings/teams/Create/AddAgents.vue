<template>
  <div class="wizard-body w-[75%] flex-shrink-0 flex-grow-0 max-w-[75%] overflow-y-auto">
    <form class="mx-0 flex flex-wrap" @submit.prevent="addAgents">
      <div class="w-full">
        <page-header :header-title="headerTitle" :header-content="$t('TEAMS_SETTINGS.ADD.DESC')" />
      </div>
      ...
      <div class="w-full">
        ...
        <agent-selector :agent-list="agentList" :selected-agents="selectedAgents"
          :update-selected-agents="updateSelectedAgents" :is-working="isCreating"
