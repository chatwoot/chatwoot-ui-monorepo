    ...
    <form class="flex flex-col w-full" @submit.prevent="editCampaign">
      <div class="w-full">
        ...
        <div class="editor-wrap">
          ...
          <woot-message-editor v-model="message" class="message-editor" :is-format-mode="true"
            :class="{ editor_warning: v$.message.$error }" :placeholder="$t('CAMPAIGN.ADD.FORM.MESSAGE.PLACEHOLDER')"
        ...
        <woot-input v-model="endPoint" :label="$t('CAMPAIGN.ADD.FORM.END_POINT.LABEL')" type="text"
        ...
        <woot-input v-model="timeOnPage" :label="$t('CAMPAIGN.ADD.FORM.TIME_ON_PAGE.LABEL')" type="text"
