...
<template>
  <div>
    <woot-delete-modal v-if="showDeletePopup" :show="showDeletePopup"
      @update:show="$emit('update:showDeletePopup', $event)" :on-close="closeDeletePopup"
      :on-confirm="deleteSavedCustomViews" :title="$t('FILTER.CUSTOM_VIEWS.DELETE.MODAL.CONFIRM.TITLE')"
      :message="$t('FILTER.CUSTOM_VIEWS.DELETE.MODAL.CONFIRM.MESSAGE')" :message-value="deleteMessage"
