...
<template>
  <div class="bg-white dark:bg-slate-900">
    <div class="multiselect-wrap--small">
      <contact-details-item compact :title="$t('CONVERSATION_SIDEBAR.ASSIGNEE_LABEL')">
      ...
      <multiselect-dropdown :options="agentsList" :selected-item="assignedAgent"
    ...
    <div class="multiselect-wrap--small">
      <contact-details-item compact :title="$t('CONVERSATION_SIDEBAR.TEAM_LABEL')" />
      <multiselect-dropdown :options="teamsList" :selected-item="assignedTeam"
    ...
    <div class="multiselect-wrap--small">
      <contact-details-item compact :title="$t('CONVERSATION.PRIORITY.TITLE')" />
      <multiselect-dropdown :options="priorityOptions" :selected-item="assignedPriority"
    ...
    <contact-details-item compact :title="$t('CONVERSATION_SIDEBAR.ACCORDION.CONVERSATION_LABELS')" />
