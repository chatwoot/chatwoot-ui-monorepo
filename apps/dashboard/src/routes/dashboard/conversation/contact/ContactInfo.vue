    ...
    <div class="text-left rtl:text-right">
      ...
      <div class="mt-2 w-full">
        <div v-if="showAvatar" class="flex items-start mb-2 gap-1.5">
          <h3 class="text-base text-slate-800 dark:text-slate-100 capitalize whitespace-normal my-0">
            {{ contact.name }}
          </h3>
      ...
      <div class="flex items-center w-full mt-2 gap-2">
        ...
        <woot-button v-tooltip="$t('CONTACT_PANEL.MERGE_CONTACT')" title="$t('CONTACT_PANEL.MERGE_CONTACT')" icon="merge"
          variant="smooth" size="small" color-scheme="secondary" :disabled="uiFlags.isMerging" @click="openMergeModal" />
      ...
      <new-conversation v-if="contact.id" :show="showConversationModal" :contact="contact"
