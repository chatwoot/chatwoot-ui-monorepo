      ...
      <div class="w-full">
        <div class="w-full">
          ...
          <div v-if="isEmailOrWebWidgetInbox">
            ...
            <reply-email-head v-if="isAnEmailInbox" v-model:cc-emails="ccEmails" v-model:bcc-emails="bccEmails" />
            <div class="editor-wrap">
              <woot-message-editor v-model="message" class="message-editor" :class="{ editor_warning: v$.message.$error }"
                :enable-variables="true" :signature="signatureToApply" :allow-signature="true"
                :placeholder="$t('NEW_CONVERSATION.FORM.MESSAGE.PLACEHOLDER')" @toggle-canned-menu="toggleCannedMenu"
          ...
          <div v-if="isEmailOrWebWidgetInbox" class="flex flex-col">
            <file-upload ref="uploadAttachment" input-id="newConversationAttachment" :size="4096 * 4096"
              ...
              <woot-button class-names="button--upload" icon="attach" emoji="📎" color-scheme="secondary" variant="smooth"
                size="small">
