...
import { INBOX_TYPES } from '@chatwoot/shared/mixins/inboxMixin';
import { ExceptionWithMessage } from '@chatwoot/shared/helpers/CustomErrors';
import { getInboxSource } from 'dashboard/helper/inbox';
import { required, requiredIf } from 'vuelidate/lib/validators';
import inboxMixin from '@chatwoot/shared/mixins/inboxMixin';
import FileUpload from 'vue-upload-component';
import AttachmentPreview from 'dashboard/components/widgets/AttachmentsPreview.vue';
import { ALLOWED_FILE_TYPES } from '@chatwoot/shared/constants/messages';
