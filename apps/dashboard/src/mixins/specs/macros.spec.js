...
describe('webhookMixin', () => {
  describe('#getEventLabel', () => {
    it('returns correct i18n translation:', () => {
      ...
      expect(wrapper.vm.getDropdownValues('assign_agent')).toEqual([{ id: 'self', name: 'Self' }, ...agents]);
      expect(wrapper.vm.getDropdownValues('change_priority')).toEqual(PRIORITY_CONDITION_VALUES);
