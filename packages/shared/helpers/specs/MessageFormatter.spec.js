...
<h2>tool</h2>`
  ...
  describe('tweets', () => {
    ...
    it('should add links to @mentions', () => {
      ...
      expect(new MessageFormatter(message, true, false).formattedMessage).toMatch(
  ...
  describe('private notes', () => {
    ...
    it('should add links to @mentions', () => {
      const message = '@chatwootapp is an opensource tool thanks @longnonexistenttwitterusername';
      expect(new MessageFormatter(message, false, true).formattedMessage).toMatch(message);
    });
